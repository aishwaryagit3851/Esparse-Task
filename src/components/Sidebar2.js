        ...
        <>
          <div><Navbar2/></div>
            <div className="container">
                <div style={{ width: isOpen ? "200px" : "75px" }} className="sidebar2">
                    <NavLink to="/sidebar2/dashboard" className="link">
                        <i className="bi bi-ui-radios-grid main-icon" onClick={toggle}></i>
                        <div style={{ display: isOpen ? "block" : "none" }} className="link_text">Dashborad</div>
                    </NavLink>
                    ...
                    <div className={storeOpen && isOpen ? "item-submenu active" : "item-submenu"}>
                        ...
                        <NavLink to="/sidebar2/bookstore/addbook" className="link"><span>Add book</span> </NavLink>
                        <NavLink to="/sidebar2/bookstore/viewbook" className="link"><span>View book</span></NavLink>
                    </div>
